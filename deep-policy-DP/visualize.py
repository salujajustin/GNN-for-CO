...
# instances: a list indexed by G graphs, N nodes, and C coordinate (2-dimensional)
instances = load_dataset(args.instances)

# solutions: a list of solutions <tuple>: (cost, solution, duration)
solutions = None
if args.solutions is not None:
    solutions, extra = load_dataset(args.solutions)

# heatmaps: a np array of size (num instances, N, N) where N = num nodes
heatmaps = None
